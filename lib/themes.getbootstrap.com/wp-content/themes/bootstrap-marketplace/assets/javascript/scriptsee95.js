jQuery(document).ready(function ( $ ) {
    ...
    $('#billToEditable').popover({
      'placement':'left',
      'html': true,
      'content':'<div class="mb-1 d-flex justify-content-between align-items-center"><strong>Billing information is editable</strong><button style="font-size: 1.25rem;" class="close">×</button></div><span class="text-gray">Click your information and type to make edits, including adding a VAT or a company name!<span>',
      'trigger': 'manual'
    }).popover('show');
