travel_app.controller("TransportationPostController", function ($scope, $location, $window, $sce, $routeParams, $timeout, $rootScope, $http, PostServiceAD) {
    ...
    $scope.getTransportationList = function () {
        PostServiceAD.getTrans($scope.currentPage, $scope.pageSize, $scope.sortBy, $scope.sortDir, $scope.isActive, '',brandId)
    ...
    $scope.searchName = function () {
        ...
        searchTimeout = $timeout(function () {
            PostServiceAD.getTrans($scope.currentPage, $scope.pageSize, $scope.sortBy, $scope.sortDir, $scope.isActive, $scope.searchTerm, brandId)
                .then(function (response) {
                    if (response.data.data === null || response.data.data.content.length === 0) {
                        $scope.transList.length = 0;
                        $scope.totalElements = 0;
