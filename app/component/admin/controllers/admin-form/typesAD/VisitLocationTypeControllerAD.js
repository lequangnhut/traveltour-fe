travel_app.controller('VisitLocationTypeControllerAD',
    function ($scope, $location, $sce, $rootScope, $routeParams, $timeout, VisitLocationTypeServiceAD, Base64ObjectService) {
