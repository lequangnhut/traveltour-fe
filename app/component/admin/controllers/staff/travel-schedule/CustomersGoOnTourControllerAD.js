travel_app.controller('CustomersGoOnTourControllerAD',
    function ($scope, $rootScope, $sce, $location, $routeParams, $timeout, CustomersGoOnTourServiceAD, TourDetailsServiceAD) {
