travel_app.controller('BasicTourControllerAD',
    function ($scope, $sce, $location, $routeParams, $timeout, ToursServiceAD, ToursTypeServiceAD, Base64ObjectService) {
        ...
        let tourId = Base64ObjectService.decodeObject($routeParams.id);
