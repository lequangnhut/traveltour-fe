travel_app.controller('DecentralizationControllerStaffAD', function ($scope, $sce, $timeout, $location, $routeParams, AccountServiceAD, AuthService, DecentralizationServiceAD) {
    let searchTimeout;
    ...
    $scope.init = function () {
         ...
         * Tìm kiếm
         */
        $scope.searchDecentralizationStaff = function () {
            if (searchTimeout) $timeout.cancel(searchTimeout);

            searchTimeout = $timeout(function () {
                DecentralizationServiceAD.findAllDecentralizationStaff($scope.currentPage, $scope.pageSize, $scope.sortBy, $scope.sortDir, $scope.searchTerm)
