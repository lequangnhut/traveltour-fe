travel_app.controller('DecentralizationControllerStaffAD', function ($scope, $timeout, $location, $routeParams, AccountServiceAD, AuthService, DecentralizationServiceAD) {
    let searchTimeout;
