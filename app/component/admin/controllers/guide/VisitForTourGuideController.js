travel_app.controller('VisitForTourGuideController',
    function ($scope, $sce, $location, $routeParams, $timeout, GuideService, LocalStorageService, Base64ObjectService) {
        ...
        $scope.getBookingTourVisitList = () => {
            $scope.isLoading = true;
            GuideService.getAllVisitByInfo($scope.currentPage, $scope.pageSize, $scope.sortBy, $scope.sortDir, tourDetailId, $scope.searchTerm)
                .then((response) => {
