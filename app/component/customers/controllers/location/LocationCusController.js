travel_app.controller('LocationCusController',
    function ($scope, $filter, $location, MapBoxService, LocationCusService, Base64ObjectService) {
        ...
        function createPopupContent(location) {
            let visitLocationId = Base64ObjectService.encodeObject(location.id);
            return `
                    <div class="single-blog-post-four" style="background: #F8F8F8">
                        ...
                        <div class="entry-content">
                            ...
                            <a href="/tourism-location/tourism-location-detail/${visitLocationId}">
                                <button class="main-btn filled-btn detail-link" data-bs-dismiss="modal">
                                    Xem chi tiết
