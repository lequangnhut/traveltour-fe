travel_app.controller('TourDetailCusController',
    function ($scope, $location, $sce, $timeout, $filter, $routeParams, $window, LocalStorageService,
              UserLikeService, UserCommentsService, RoomTypeServiceCT, AuthService, TourTripsServiceAD,
              TourDetailsServiceAD, TourDetailCusService, MapBoxService, ToursServiceAD, Base64ObjectService) {
        let user = null
