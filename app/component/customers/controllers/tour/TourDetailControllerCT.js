travel_app.controller('TourDetailController', function ($scope, $location, $sce, $routeParams, $anchorScroll, TourDetailServiceCT, MapBoxService) {
    $anchorScroll();
                ...
                MapBoxService.geocodeAddress(toLocation, function (error, toCoordinates) {
                    if (!error) {
                        ...
                        map.on('load', () => {
                            ...
                            fetch(`https://api.mapbox.com/directions/v5/mapbox/driving/${fromCoordinates[0]},${fromCoordinates[1]};${toCoordinates[0]},${toCoordinates[1]}?geometries=geojson&steps=true&access_token=${mapboxgl.accessToken}`)
