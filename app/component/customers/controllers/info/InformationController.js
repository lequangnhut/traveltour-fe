travel_app.controller("InformationController", function ($scope, $sce, $location, $window, $routeParams, $timeout, Base64ObjectService, $rootScope, $http, CustomerServiceAD, LocalStorageService, AuthService, HistoryOrderServiceCUS) {
